...
**Description:** AI-assisted storytelling tools and multimedia memoirs
...
- **title:** Object with default and template
  ...
  - template: "%s | MemoryMosaic Premium" (for page-specific titles)

- **description:** "Preserve Life Stories"

- **keywords:** Array with relevant keywords
  - "memorymosaic premium"
  - Additional relevant keywords for the product

- **authors:** [{ name: "MemoryMosaic Premium" }]

- **creator:** "MemoryMosaic Premium"
...
- Result: "Sign In | MemoryMosaic Premium"
...
- "/" → "MemoryMosaic Premium"
- "/login" → "Sign In | MemoryMosaic Premium"
- "/signup" → "Sign Up | MemoryMosaic Premium"
- "/dashboard" → "Dashboard | MemoryMosaic Premium"
